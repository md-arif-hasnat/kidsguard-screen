...
interface AppActivityPanelProps {
  childId: string;
}

export default function AppActivityPanel({ childId }: AppActivityPanelProps) {
  ...
  if (!canViewActivity) {
      return (
          <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-slate-500 max-w-md mx-auto mt-2 text-sm italic">
    ...
    <div className="animate-in fade-in duration-500 space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 font-medium text-sm mt-1">
            Usage for <span className="text-slate-900 font-bold">{childStatus?.childName || "Loading..."}</span>
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="py-24 text-center bg-white rounded-3xl border border-slate-200">
            ...
            <h2 className="text-xl font-bold text-slate-800">No activity recorded for this date.</h2>
